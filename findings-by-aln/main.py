...
class FAC():
    ...
    def findings(self, report_id=None):
        print("[bold magenta]FINDINGS[/bold magenta]")
        console = Console()
    ...
    def awards(self, report_id=None):
        print("[bold magenta]AWARDS[/bold magenta]")
        console = Console()
        ...
        for dg in gq:
            ...
            for df in dfq:
                ...
                for res in jres:
                    ...
                    print(f"Updating awards for [bold blue]{df.report_id}[/bold blue] {df.award_reference} {df.reference_number}")
                    (df
                     .update(**res)
                     .where((DailyFindings.report_id == dg.report_id)
    ...
    def to_xlsx(self):
        print("[bold magenta]TO XLSX[/bold magenta]")
        wb = Workbook()
        self._add_sheets(
            wb,
            get_unique_agency_numbers(),
...
def main(acceptance_date, clean, omit_generals, omit_findings, omit_awards, report_id):
